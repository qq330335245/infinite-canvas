export default {
    ...
    settingsPanels: {
        ...
        image: { title: "图像设置", quality: "质量", size: "尺寸", resolution: "分辨率", align16: "16 倍数对齐", align16Hint: "输入完成后自动向上补成 16 的倍数", aspectRatio: "宽高比", transparent: "透明背景", transparentHint: "开启后生成无背景的透明图像（仅部分模型可用）", count: "生成张数", images: "{{count}} 张", grokResolutionHint: "官方：1k / 2k。", grokQualityHint: "仅 grok-imagine-image-2.0 支持 quality=low / medium（默认 medium）。", grokRatioHint: "官方宽高比含 1:1、16:9、9:16、4:3、3:4、3:2、2:3、2:1、1:2、19.5:9、20:9、auto。" },
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", autoFromFirstFrame: "有首帧则跟首帧，否则 16:9", grokResolutionHint: "官方：480p / 720p（默认 480p）。1080p 仅 grok-imagine-video-1.5 的文生/图生可用；参考生视频最高 720p。", grokResolutionHint15: "官方：1.5 文生/图生支持 480p / 720p / 1080p；参考生视频（reference_images）仍封顶 720p。", grokRatioHint: "官方宽高比：1:1、16:9、9:16、4:3、3:4、3:2、2:3。自适应会按首帧推断，否则 16:9。", grokDurationHint: "官方时长 1–15 秒。", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", photoLandscape: "3:2 横图", photoPortrait: "2:3 竖图", cinematic: "宽银幕", adaptive: "自适应" } },
    ...
    videoWorkbench: {
        ...
        references: "参考图",
        firstFrame: "首帧图（可选）",
        firstFrameHint: "仅 1 张，对应 Grok image 首帧（图生视频）。与下方参考图互斥，设了首帧就不会发 reference_images",
        extraReferences: "参考图",
        extraReferencesHint: "全部走 reference_images（参考生视频），不会自动当首帧。与首帧互斥；有首帧时请先清空首帧。最多 8 张",
        videoReferences: "参考视频",
        audioReferences: "参考音频",
        removeImage: "移除参考图",
        removeFirstFrame: "移除首帧",
        removeVideo: "移除参考视频",
        removeAudio: "移除参考音频",
        dropReferences: "松开即可上传参考资产",
        noImages: "暂无参考图，可拖入文件，最多 9 张",
        noFirstFrame: "未设置首帧（可选）。拖入或上传 1 张图作为 image 首帧；与参考图二选一",
        noGrokImages: "暂无参考图。这里只作为 reference_images，不会自动当首帧；与首帧二选一",
        firstFrameClearsReferences: "官方不允许 image 与 reference_images 同开。已设置首帧，参考图已清空",
        referencesClearsFirstFrame: "官方不允许 image 与 reference_images 同开。已添加参考图，首帧已清空",
        firstFrameBlocksReferences: "已设置首帧，不能再加参考图。请先移除首帧，或继续只用首帧图生视频",
        noVideos: "暂无参考视频，可拖入文件，最多 3 个",
        noAudio: "暂无参考音频，可拖入文件，最多 3 个，mp3/wav，单个 15MB 内",
        labels: { firstFrame: "首帧", reference: "参考{{index}}" },
        ...
        empty: "还没有生成视频",
        workflow: "工作流",
        workflows: { generate: "生成", edit: "编辑", extend: "扩展" },
        workflowHints: {
            generate: "文生 / 图生 / 参考生：POST /v1/videos/generations",
            edit: "修改已有视频：POST /v1/videos/edits（需源视频 + 提示词；官方仅 grok-imagine-video）",
            extend: "从末帧续写：POST /v1/videos/extensions（扩展段 2–10 秒，默认 6）",
        },
        sourceVideo: "源视频",
        sourceVideoHint: "官方 video.url：HTTPS 或上传后的本地视频",
        noSourceVideo: "请上传要编辑或扩展的源视频",
        sourceVideoRequired: "请先上传源视频",
        extendDuration: "扩展时长",
        extendDurationHint: "官方扩展段 duration 为 2–10 秒（不是成片总时长）",
        jobStatus: "状态：{{status}}",
        pollingHint: "正在轮询 Grok2API 任务进度…",
    },
    canvas: {
